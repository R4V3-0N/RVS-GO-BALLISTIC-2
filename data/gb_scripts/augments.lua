...
local ammoWeapons = {}
do
    function ammoWeaponScan()
        if #ammoWeapons == 0 then
...
script.on_init(ammoWeaponScan)
script.on_game_event("TUTORIAL_START", false, ammoWeaponScan)
script.on_game_event("START_BEACON", false, ammoWeaponScan)
